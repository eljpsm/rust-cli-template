...
The `greet` and `count` commands are scaffolding. Replace them with the real
tool and delete this sentence.

## Commands

Common tasks live in the [Makefile](Makefile).

To run unit tests matching a name, use cargo directly: `cargo test greet`.
